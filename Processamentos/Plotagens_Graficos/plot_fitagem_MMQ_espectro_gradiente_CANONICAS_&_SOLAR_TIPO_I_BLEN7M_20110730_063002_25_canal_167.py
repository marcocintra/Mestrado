...
err = np.array([
    0.000000000000000000e+00,  # err0 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L1
    1.310571436720052996e-01,  # err1 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L2
    2.046953731579561342e-01,  # err2 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L3
    2.081418069322308606e-01,  # err3 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L4
    2.318195698334452048e-01,  # err4 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L5
    2.587040352292213075e-01,  # err5 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L6
    3.129627926456499121e-01,  # err6 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L7
    2.915368746556507018e-01,  # err7 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L8
    3.436605071208434503e-01,  # err8 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L9
    3.941312487783361074e-01,  # err9 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L10
    4.806504863836137953e-01,  # err10 = Desvio Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L11
...
y = np.array([
    4.862808585166931152e-01,  # y0 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L1
    6.096868738532066345e-01,  # y1 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L2
    6.472717358006371269e-01,  # y2 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L3
    7.248395010828971863e-01,  # y3 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L4
    7.733169424533844483e-01,  # y4 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L5
    7.722447870506180534e-01,  # y5 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L6
    8.431149655580520985e-01,  # y6 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L7
    8.377507608901295644e-01,  # y7 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L8
    7.773540119992362607e-01,  # y8 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L9
    7.186386603675782858e-01,  # y9 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L10
    5.117504441075855226e-01,  # y10 = GA Type I Burst (BLEN7M_20110730_063002_25_canal_167) - L11
...
#BRINCANDO COM REGRESSÃO LINEAR
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-TIPOI-SUBIDA.txt', lsq)
plt.plot(X, m*X + c, color='magenta', ls='--', label="MMQ-1")
MMQ1 = mlines.Line2D([], [], ls='--', color="magenta", label="Fitagem MMQ de L1 a L8 - BLEN7M_20110730_063002_25 - Canal 167) - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-TIPOI-DESCIDA.txt', lsq)
plt.plot(X, m*X + c, color='magenta', ls=':', label="MMQ-2")
MMQ2 = mlines.Line2D([], [], ls=':', color="magenta", label="Fitagem MMQ de L8 a L11 - BLEN7M_20110730_063002_25 - Canal 167) - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-PMODEL-SUBIDA.txt', lsq)
plt.plot(X, m*X + c, color='red', ls='--', label="MMQ3")
MMQ3 = mlines.Line2D([], [], ls='--', color="red", label="Fitagem MMQ de L1 a L8 - A8_PModel - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-PMODEL-DESCIDA.txt', lsq)
plt.plot(X, m*X + c, color='red', ls=':', label="MMQ4")
MMQ4 = mlines.Line2D([], [], ls=':', color="red", label="Fitagem MMQ de L8 a L11 - A8_PModel - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-PMODEL.txt', lsq)
plt.plot(X, m*X + c, ls='--', color='blue', label="MMQ5")
MMQ5 = mlines.Line2D([], [], ls='--', color="blue", label="Fitagem MMQ de L1 a L8 - A7_Henon_x - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-HENON-DESCIDA.txt', lsq)
plt.plot(X, m*X + c, color='blue', ls=':', label="Fitagem MMQ de L8 a L11 - A7_Henon_x - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
MMQ6 = mlines.Line2D([], [], ls=':', color="blue", label="Fitagem MMQ de L8 a L11 - A7_Henon_x - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
lsq = np.array([m, c])
print(m, c)
np.savetxt('LSQ-CHUA.txt', lsq)
plt.plot(X, m*X + c, ls='--', color='cyan', label="MMQ7")
MMQ7 = mlines.Line2D([], [], ls='--', color="cyan", label="Fitagem MMQ de L1 a L8 - A5_Chua_Chaos_Y1 - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
print(m, c)
np.savetxt('LSQ-CHUA.txt', lsq)
plt.plot(X, m*X + c, ls=':', color='cyan', label="MMQ8")
MMQ8 = mlines.Line2D([], [], ls=':', color="cyan", label="Fitagem MMQ de L8 a L11 - A5_Chua_Chaos_Y1 - Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c))
...
plt.savefig("FITAGEM.pdf", format="pdf",
...
CA = mlines.Line2D([], [], linestyle="solid", label='BLEN7M_20110730_063002_25 - Canal 167)', color="black")
...
legend = plt.legend(loc='center',
                    handles=[CA, MMQ1, MMQ2, A5_Chua_Chaos_Y1, MMQ7, MMQ8, A7_Henon_x, MMQ5, MMQ6, A8_PModel, MMQ3, MMQ4, L1, L2,
                             L3, L4, L5, L6, L7, L8, L9, L10, L11], fontsize="15", title="Legenda\n")

plt.setp(legend.get_title(), fontsize='18')
plt.grid(False)
plt.axis('off')
plt.savefig('LEGENDA.pdf', format="pdf", figsize=(1600, 1600), dpi=120)
plt.show()
plt.close()
