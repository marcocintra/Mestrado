...
def main():
    ...
    # Tamanho das fontes
    tamanhoFonteEixoX = 21
    tamanhoFonteEixoY = 21
    tamanhoFonteTitulo = 21
    tamanhoFontePrincipal = 35

    # Título principal
    tituloPrincipal = 'TESTANDO =)'
    ...
    textoTituloOriginal = 'Série temporal'
    ...
    textoPSDY = 'Potência'
    textoTituloPSD = r'Power Spectral Density $\beta$ = '
