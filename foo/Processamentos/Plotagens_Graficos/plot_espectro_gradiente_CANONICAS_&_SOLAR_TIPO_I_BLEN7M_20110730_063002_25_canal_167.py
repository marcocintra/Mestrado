...
#plt.suptitle("PMODEL - L1 a L8", size="22")
#plt.title("Equação reduzida da reta, y=mx+c:\n y="+str(m)+"x"+"+"+str(c), loc="left", size="20", color="red")
#plt.xlabel("G1", size="22")
#plt.ylabel("G2", size="22")

#z = np.polyfit(x[0:8], y[88:96], 1)
#plt.plot(z)
